...
class TinyGPT2Forward(torch.nn.Module):
...
def main():
    parser = argparse.ArgumentParser(description="sshleifer/tiny-gpt2 -> linalg MLIR")
    parser.add_argument("-o", "--output", type=str, default="tiny_gpt2.mlir")
    ...
    model = TinyGPT2Forward(args.model)
