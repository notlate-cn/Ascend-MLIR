...
| full value-level workspace/copy materialization enhancement | `Planned` | 真实 workspace alloc/subview、更多 producer/consumer copy materialization 和 slot reuse 继续作为后续增强 | Phase 3B+ |
