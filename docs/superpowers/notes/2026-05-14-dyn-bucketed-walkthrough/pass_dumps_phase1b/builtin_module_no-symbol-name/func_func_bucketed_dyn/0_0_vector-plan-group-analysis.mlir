// -----// IR Dump After VectorPlanGroupAnalysis (vector-plan-group-analysis) //----- //
func.func @bucketed_dyn(%arg0: tensor<?x?x?xf32>, %arg1: tensor<?x?x?xf32>, %arg2: tensor<?x?x?xf32>, %arg3: tensor<?x?x?xf32>, %arg4: tensor<?x?x?xf32>, %arg5: tensor<?x?x?xf32>, %arg6: tensor<?x?x?xf32>, %arg7: tensor<?x?xf32>, %arg8: tensor<?x?xf32>) -> (tensor<?x?xf32>, tensor<?x?xf32>) {
  ...
  %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg4, %arg5, %arg6 : tensor<?x?x?xf32>, tensor<?x?x?xf32>, tensor<?x?x?xf32>) outs(%arg8 : tensor<?x?xf32>) attrs =  {vector_plan.group_id = 1 : i32, vector_plan.topo_index = 1 : i32} {
