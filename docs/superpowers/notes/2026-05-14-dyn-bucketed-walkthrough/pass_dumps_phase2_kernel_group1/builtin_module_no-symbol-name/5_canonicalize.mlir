  ...
  func.func private @kernel_group1__v0(%arg0: memref<?x?x?xf32> {afir.symbolic_shape = "s0,s1,s2"}, %arg1: memref<?x?x?xf32> {afir.symbolic_shape = "s0,s1,s2"}, %arg2: memref<?x?x?xf32> {afir.symbolic_shape = "s0,s1,s2"}, %arg3: memref<?x?xf32> {afir.symbolic_shape = "s0,s1"}, %arg4: index {vector_plan.default_tile_size = 128 : i64}, %arg5: index {vector_plan.default_tile_size = 16 : i64}) -> memref<?x?xf32> attributes {afir.axis_extent_expr = "(arg0_dim0 * arg0_dim1)", afir.axis_extents = ["(s0*s1)", "s2"], afir.block_dim_expr = "ceil((arg0_dim0 * arg0_dim1)/XBLOCK)", afir.dim_symbols = [{arg = 0 : i64, dim = 0 : i64, id = 0 : i64}, {arg = 0 : i64, dim = 1 : i64, id = 1 : i64}, {arg = 0 : i64, dim = 2 : i64, id = 2 : i64}]} {
    ...
    scf.if %33 {
      ...
      scf.for %arg6 = %c0 to %37 step %arg5 {
        ...
        %subview_14 = memref.subview %collapse_shape_3[%49] [%arg5] [1] : memref<?xf32> to memref<?xf32, strided<[1], offset: ?>>
        ...
        ascendc.data_copy_l2 %50, %51, %38 : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, index
        ...
        ascendc.data_copy_l2 %53, %54, %39 : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, index
        ...
        ascendc.data_copy_l2 %56, %57, %40 : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, index
        ...
        ascendc.duplicate_l2 %59, %cst, %41 : !ascendc.local_tensor<*xf32>, f32, index
        %60 = ascendc.tbuf.get_tensor %25 : !ascendc.tbuf<veccalc>, !ascendc.local_tensor<*xf32>
        ascendc.add_l2 %60, %52, %55, %41 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
        %61 = ascendc.tbuf.get_tensor %24 : !ascendc.tbuf<veccalc>, !ascendc.local_tensor<*xf32>
        ascendc.mul_l2 %61, %60, %58, %41 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
        ascendc.add_l2 %59, %59, %61, %41 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
      ...
      scf.if %48 {
        ...
        %subview_17 = memref.subview %collapse_shape_3[%49] [%arg5] [1] : memref<?xf32> to memref<?xf32, strided<[1], offset: ?>>
