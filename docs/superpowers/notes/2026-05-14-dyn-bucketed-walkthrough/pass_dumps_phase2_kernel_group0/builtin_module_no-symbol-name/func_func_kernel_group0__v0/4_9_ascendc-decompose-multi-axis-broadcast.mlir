// -----// IR Dump After AscendCDecomposeMultiAxisBroadcastPass (ascendc-decompose-multi-axis-broadcast) //----- //
func.func private @kernel_group0__v0(%arg0: memref<?x?x?xf32> {afir.symbolic_shape = "s0,s1,s2"}, %arg1: memref<?x?x?xf32> {afir.symbolic_shape = "s0,s1,s2"}, %arg2: memref<?x?x?xf32> {afir.symbolic_shape = "s0,s1,s2"}, %arg3: memref<?x?x?xf32> {afir.symbolic_shape = "s0,s1,s2"}, %arg4: memref<?x?xf32> {afir.symbolic_shape = "s0,s1"}, %arg5: index {vector_plan.default_tile_size = 128 : i64}, %arg6: index {vector_plan.default_tile_size = 16 : i64}) -> memref<?x?xf32> attributes {afir.axis_extent_expr = "(arg0_dim0 * arg0_dim1)", afir.axis_extents = ["(s0*s1)", "s2"], afir.block_dim_expr = "ceil((arg0_dim0 * arg0_dim1)/XBLOCK)", afir.dim_symbols = [{arg = 0 : i64, dim = 0 : i64, id = 0 : i64}, {arg = 0 : i64, dim = 1 : i64, id = 1 : i64}, {arg = 0 : i64, dim = 2 : i64, id = 2 : i64}]} {
  ...
  %39 = scf.for %arg7 = %c0 to %11 step %arg5 iter_args(%arg8 = %collapse_shape_4) -> (memref<?xf32>) {
    %40 = arith.subi %11, %arg7 : index
    %41 = arith.minsi %arg5, %40 : index
    %42 = arith.divsi %41, %arg6 : index
    %43 = arith.muli %42, %arg6 : index
    %44 = arith.muli %arg6, %dim_7 : index
    %45 = arith.muli %arg6, %dim_8 : index
    %46 = arith.muli %arg6, %dim_9 : index
    %47 = arith.muli %arg6, %dim_10 : index
    %48 = arith.muli %arg6, %dim_7 : index
    %49 = arith.muli %arg6, %dim_7 : index
    ...
    ascendc.pipe.init_buffer %0, %30, %56 : !ascendc.tbuf<veccalc>, index
    ascendc.pipe.init_buffer %0, %31, %54 : !ascendc.tbuf<veccalc>, index
    ascendc.pipe.init_buffer %0, %32, %52 : !ascendc.tbuf<veccalc>, index
    ascendc.pipe.init_buffer %0, %33, %50 : !ascendc.tbuf<veccalc>, index
    %57 = scf.for %arg9 = %c0 to %43 step %arg6 iter_args(%arg10 = %arg8) -> (memref<?xf32>) {
      %60 = arith.addi %arg7, %arg9 : index
      ...
      %subview_18 = memref.subview %arg10[%60] [%arg6] [1] : memref<?xf32> to memref<?xf32, strided<[1], offset: ?>>
      ...
      ascendc.data_copy_l2 %61, %62, %44 : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, index
      ...
      ascendc.data_copy_l2 %64, %65, %45 : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, index
      ...
      ascendc.data_copy_l2 %67, %68, %46 : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, index
      ...
      ascendc.data_copy_l2 %70, %71, %47 : !ascendc.local_tensor<*xf32>, !ascendc.global_tensor<*xf32>, index
      ...
      ascendc.duplicate_l2 %73, %cst, %48 : !ascendc.local_tensor<*xf32>, f32, index
      %74 = ascendc.tbuf.get_tensor %32 : !ascendc.tbuf<veccalc>, !ascendc.local_tensor<*xf32>
      ascendc.add_l2 %74, %63, %66, %48 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
      %75 = ascendc.tbuf.get_tensor %31 : !ascendc.tbuf<veccalc>, !ascendc.local_tensor<*xf32>
      ascendc.mul_l2 %75, %74, %69, %48 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
      %76 = ascendc.tbuf.get_tensor %30 : !ascendc.tbuf<veccalc>, !ascendc.local_tensor<*xf32>
      ascendc.add_l2 %76, %75, %72, %48 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
      ascendc.add_l2 %73, %73, %76, %48 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
    ...
    %58 = arith.cmpi slt, %43, %41 : index
    %59 = scf.if %58 -> (memref<?xf32>) {
      ...
      %subview_22 = memref.subview %57[%60] [%arg6] [1] : memref<?xf32> to memref<?xf32, strided<[1], offset: ?>>
      ...
      scf.yield %57 : memref<?xf32>
    } else {
      scf.yield %57 : memref<?xf32>
    }
    scf.yield %59 : memref<?xf32>
  }
  %expand_shape = memref.expand_shape %39 [[0, 1]] output_shape [%dim, %dim_0] : memref<?xf32> into memref<?x?xf32>
