// RUN: afir-opt %s --ascend-normalize --ascend-kernelize --ascend-schedule='target-tile-policy=legacy-default' --ascend-realize='dump-report=true debug-stage=realize' 2>&1 | FileCheck %s
