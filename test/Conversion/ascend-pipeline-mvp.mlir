// RUN: ascend-mlir-opt --ascend-normalize --ascend-kernelize --ascend-schedule='target-tile-policy=legacy-default' %s | FileCheck %s
...
// CHECK-DAG: ascend.kernel
// CHECK-DAG: ascend.op_role
// CHECK-DAG: ascend.schedule.family
