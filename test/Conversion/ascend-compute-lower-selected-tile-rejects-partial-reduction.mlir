...
// CHECK: selected reduction tile requires full reduction axis
func.func @reject_partial_reduction_selected_tile() {
  %in = memref.alloc() : memref<64x16xf16, 9 : i32>
  %out = memref.alloc() : memref<64xf16, 10 : i32>
  %gm = memref.alloc() : memref<64xf16>
  linalg.generic {
      indexing_maps = [#full, #project_parallel],
      iterator_types = ["parallel", "reduction"],
      ascend.schedule.selected_tile_shape = array<i64: 64, 8>}
      ins(%in : memref<64x16xf16, 9 : i32>)
