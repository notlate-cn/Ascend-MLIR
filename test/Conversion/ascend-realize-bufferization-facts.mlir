// RUN: ascend-mlir-opt %s --split-input-file --ascend-realize='dump-report=true debug-stage=realize' 2>&1 | FileCheck %s
...
func.func @scheduled_mixed_use_kernel(%arg0: tensor<64xf16>, %arg1: tensor<64xf16>) -> (tensor<64xf16>, tensor<64xf16>) attributes {ascend.normalized = true} {
  %empty0 = tensor.empty() : tensor<64xf16>
  %mid = linalg.generic {
    indexing_maps = [
      affine_map<(d0) -> (d0)>,
  ...
  return %mid, %out : tensor<64xf16>, tensor<64xf16>
}
