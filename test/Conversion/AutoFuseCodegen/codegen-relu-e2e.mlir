// RUN: afir-opt %s --auto-fuse-codegen 2>&1 | FileCheck %s --check-prefix=MLIR
// RUN: afir-opt %s --auto-fuse-codegen 2>&1 | afir-translate -mlir-to-cann | FileCheck %s --check-prefix=CANN
//
// ReLU (max(x, 0)) end-to-end through --auto-fuse-codegen + afir-translate.
