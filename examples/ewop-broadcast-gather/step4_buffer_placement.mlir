  ...
  func.func @ewop_broadcast_gather(%arg0: memref<?x?xf16>, %arg1: memref<?xi32>, %arg2: memref<?xf16>, %arg3: i64, %arg4: i64) -> memref<?x?xf16> {
    ...
    %2 = scf.for %arg5 = %c0 to %dim step %1 iter_args(%arg6 = %alloc_1) -> (memref<?x?xf16>) {
      ...
      %5 = scf.for %arg7 = %c0 to %4 step %0 iter_args(%arg8 = %subview_5) -> (memref<?x?xf16, strided<[?, 1], offset: ?>>) {
        ...
        %dim_8 = memref.dim %subview_6, %c0_7 : memref<?xi32, strided<[1]>>
        %alloc_9 = memref.alloc(%dim_8) : memref<?xi32, 9 : i32>
        memref.copy %subview_6, %alloc_9 : memref<?xi32, strided<[1]>> to memref<?xi32, 9 : i32>
        %subview_10 = memref.subview %subview_4[%arg7, 0] [%6, %dim_0] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        %subview_11 = memref.subview %arg8[%arg7, 0] [%6, %dim_0] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        %c0_12 = arith.constant 0 : index
        %dim_13 = memref.dim %subview_11, %c0_12 : memref<?x?xf16, strided<[?, 1], offset: ?>>
        %c1_14 = arith.constant 1 : index
        %dim_15 = memref.dim %subview_11, %c1_14 : memref<?x?xf16, strided<[?, 1], offset: ?>>
        %alloc_16 = memref.alloc(%dim_13, %dim_15) : memref<?x?xf16, 10 : i32>
        linalg.generic {indexing_maps = [#map1, #map2, #map2], iterator_types = ["parallel", "parallel"], library_call = "gather_by_index"} ins(%alloc_9, %subview_10 : memref<?xi32, 9 : i32>, memref<?x?xf16, strided<[?, 1], offset: ?>>) outs(%alloc_16 : memref<?x?xf16, 10 : i32>) {
        ^bb0(%in: i32, %in_17: f16, %out: f16):
          linalg.yield %in_17 : f16
        }
        memref.copy %subview_11, %subview_11 : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        memref.dealloc %alloc_9 : memref<?xi32, 9 : i32>
        memref.copy %alloc_16, %subview_11 : memref<?x?xf16, 10 : i32> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        memref.dealloc %alloc_16 : memref<?x?xf16, 10 : i32>
    ...
    %3 = scf.for %arg5 = %c0 to %dim_2 step %1 iter_args(%arg6 = %alloc) -> (memref<?x?xf16>) {
      ...
      %5 = scf.for %arg7 = %c0 to %4 step %0 iter_args(%arg8 = %subview_5) -> (memref<?x?xf16, strided<[?, 1], offset: ?>>) {
        ...
        %c0_7 = arith.constant 0 : index
        %dim_8 = memref.dim %subview_6, %c0_7 : memref<?x?xf16, strided<[?, 1], offset: ?>>
        %c1_9 = arith.constant 1 : index
        %dim_10 = memref.dim %subview_6, %c1_9 : memref<?x?xf16, strided<[?, 1], offset: ?>>
        %alloc_11 = memref.alloc(%dim_8, %dim_10) : memref<?x?xf16, 9 : i32>
        memref.copy %subview_6, %alloc_11 : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, 9 : i32>
        %subview_12 = memref.subview %subview_4[%arg7] [%6] [1] : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %subview_13 = memref.subview %arg8[%arg7, 0] [%6, %dim_3] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        %c0_14 = arith.constant 0 : index
        %dim_15 = memref.dim %subview_13, %c0_14 : memref<?x?xf16, strided<[?, 1], offset: ?>>
        %c1_16 = arith.constant 1 : index
        %dim_17 = memref.dim %subview_13, %c1_16 : memref<?x?xf16, strided<[?, 1], offset: ?>>
        %alloc_18 = memref.alloc(%dim_15, %dim_17) : memref<?x?xf16, 10 : i32>
        linalg.generic {indexing_maps = [#map2, #map3, #map2], iterator_types = ["parallel", "parallel"], library_call = "broadcast_add_gathered"} ins(%alloc_11, %subview_12 : memref<?x?xf16, 9 : i32>, memref<?xf16, strided<[1], offset: ?>>) outs(%alloc_18 : memref<?x?xf16, 10 : i32>) {
        ^bb0(%in: f16, %in_19: f16, %out: f16):
          %7 = arith.addf %in, %in_19 : f16
          linalg.yield %7 : f16
        }
        memref.copy %subview_13, %subview_13 : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        memref.dealloc %alloc_11 : memref<?x?xf16, 9 : i32>
        memref.copy %alloc_18, %subview_13 : memref<?x?xf16, 10 : i32> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        memref.dealloc %alloc_18 : memref<?x?xf16, 10 : i32>
        scf.yield %arg8 : memref<?x?xf16, strided<[?, 1], offset: ?>>
      }
      memref.copy %5, %subview_5 : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
      scf.yield %arg6 : memref<?x?xf16>
