...
LayoutType | Layout数据类型，默认为空类型，即Layout<Shape<>, Stride<>>。 输入的数据类型LayoutType，需满足[约束说明](atlasascendc_api_07_00078.html#ZH-CN_TOPIC_0000002552080039__zh-cn_topic_0000002078486173_zh-cn_topic_0000001576727153_zh-cn_topic_0000001389787297_section19165124931511)。  
