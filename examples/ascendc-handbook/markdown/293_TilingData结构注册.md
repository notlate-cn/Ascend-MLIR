<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_1006.html -->
...
注册定义的TilingData结构体并和自定义算子绑定。具体使用说明请参考[调用示例](#ZH-CN_TOPIC_0000002521039936__zh-cn_topic_0000001576728165_section97001499599)。
...
#### 约束说明
  ...
  * 中间结构体和定制tilingkey结构体需注意op_type命名规则，具体见[调用示例](#ZH-CN_TOPIC_0000002521039936__zh-cn_topic_0000001576728165_section97001499599)。
...
**父主题：** [Tiling数据结构注册](atlasascendc_api_07_1004.html)
