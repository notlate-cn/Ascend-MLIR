<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0211.html -->
...
需要和[SetAtomicAdd](atlasascendc_api_07_0210.html)、[SetAtomicMax](atlasascendc_api_07_0284.html)、[SetAtomicMin](atlasascendc_api_07_0285.html)配合使用。

使用完成后，建议清空原子操作的状态（详见[DisableDmaAtomic](atlasascendc_api_07_0212.html)），以免影响后续相关指令功能。
