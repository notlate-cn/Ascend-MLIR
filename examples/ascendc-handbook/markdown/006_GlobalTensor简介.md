<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0007.html -->
...
GlobalTensor public成员函数如下。类型T支持基础数据类型以及[TensorTrait](atlasascendc_api_07_0011.html)类型，但需要遵循使用此GlobalTensor的指令的数据类型支持情况。
...
**父主题：** [GlobalTensor](atlasascendc_api_07_0007.html)
