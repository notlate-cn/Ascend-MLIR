<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0194.html -->
...
为了避免部分场景下和标准的assert接口产生冲突，assert(expr, __gm__ const char *fmt, Args&&... args)接口将被废弃，并将在后续版本移除。请不要使用该接口，可使用[ascendc_assert](atlasascendc_api_07_00168.html)的对应接口作为替代。
...
#### 约束说明
  ...
  * **该功能仅在如下场景支持****：**
    * 通过[Kernel直调](/document/detail/zh/CANNCommunityEdition/900beta1/opdevg/Ascendcopdevg/atlas_ascendc_10_0056.html)方式调用算子。
    * 通过[单算子API调用](/document/detail/zh/CANNCommunityEdition/900beta1/opdevg/Ascendcopdevg/atlas_ascendc_10_0070.html)方式调用算子。
