<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0121.html -->
...
下图展示了资源池划分的过程：
  ...
  1. 通过TPipe::[InitBuffer](atlasascendc_api_07_0110.html)接口可以申请Buffer内存并使用队列进行管理；
  2. 通过TPipe::[InitBufPool](atlasascendc_api_07_0119.html)可以划分出资源池BufPool1；
  3. 通过TPipe::[InitBufPool](atlasascendc_api_07_0119.html)可以指定BufPool1与BufPool3地址和长度复用;
  4. 通过TBufPool::[InitBuffer](atlasascendc_api_07_0125.html)及TBufPool::[InitBufPool](atlasascendc_api_07_0124.html)接口继续将BufPool1及BufPool3划分成Buffer或TBufPool资源池。
...
![](/doc_center/source/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/figure/zh-cn_image_0000002521042478.png)
...
**父主题：** [TBufPool](atlasascendc_api_07_0121.html)
