<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_1213.html -->
...
用于表示终止位置打点，一般与[TRACE_START](atlasascendc_api_07_1212.html)配套使用。
...
参数名 | 输入/输出 | 描述  
---|---|---  
apid | 输入 | 取值需与[TRACE_START](atlasascendc_api_07_1212.html)参数取值保持一致，否则影响打点结果。  
