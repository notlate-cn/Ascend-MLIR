<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0088.html -->
...
本示例仅展示Compute流程的部分代码。如需运行，请将代码段复制并粘贴到[样例模板](#ZH-CN_TOPIC_0000002521040244__section1257219551975)中的Compute函数对应位置。
...
您可以参考以下样例，了解如何使用Duplicate指令的tensor高维切分计算接口，进行更灵活的操作、实现更高级的功能。本示例仅展示Compute流程的部分代码。如需运行，请将代码段复制并粘贴到[样例模板](#ZH-CN_TOPIC_0000002521040244__section1257219551975)中的Compute函数对应位置。
