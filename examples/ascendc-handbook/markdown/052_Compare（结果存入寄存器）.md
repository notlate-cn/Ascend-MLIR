<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0067.html -->
...
#### 约束说明
  ...
  * 本接口将结果写入128bit的cmpMask寄存器中，可以用[GetCmpMask](atlasascendc_api_07_0223.html)接口获取寄存器保存的数据。
...
本样例中只展示Compute流程中的部分代码。如果您需要运行样例代码，请将该代码段拷贝并替换[样例模板](#ZH-CN_TOPIC_0000002520880240__section4466112115212)中Compute函数的部分代码即可。
