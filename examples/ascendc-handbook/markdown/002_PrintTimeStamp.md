<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_00002.html -->
...
提供时间戳打点功能，用于在算子Kernel代码中标记关键执行点。调用后会打印如下信息：
  ...
  * rsv ：保留值，默认为0，无需关注；
  * timeStamp :当前系统cycle数，用于计算时间差，时间换算规则可参考[GetSystemCycle(ISASI)](atlasascendc_api_07_0282.html)；
