<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0099.html -->
...
#### 函数原型
  ...
  * 用于[AddDeqRelu](atlasascendc_api_07_0045.html)/[Cast](atlasascendc_api_07_0073.html)/[CastDeq](atlasascendc_api_07_0074.html)的s322f16场景
  ...
  * 用于[CastDeq](atlasascendc_api_07_0074.html)（isVecDeq=false）的场景
  ...
  * 用于[CastDeq](atlasascendc_api_07_0074.html)（isVecDeq=true）的场景
...
参数名 | 输入/输出 | 描述  
---|---|---  
scale（half） | 输入 | scale量化参数，half类型。 Atlas A3 训练系列产品/Atlas A3 推理系列产品，用于[AddDeqRelu](atlasascendc_api_07_0045.html)/[Cast](atlasascendc_api_07_0073.html)/[CastDeq](atlasascendc_api_07_0074.html)的s322f16场景。 Atlas A2 训练系列产品/Atlas A2 推理系列产品，用于[AddDeqRelu](atlasascendc_api_07_0045.html)/[Cast](atlasascendc_api_07_0073.html)/[CastDeq](atlasascendc_api_07_0074.html)的s322f16场景。 Atlas 推理系列产品AI Core：用于[AddDeqRelu](atlasascendc_api_07_0045.html)或者[Cast](atlasascendc_api_07_0073.html)的s322f16场景。  
scale（float） | 输入 | scale量化参数，float类型。 用于[CastDeq](atlasascendc_api_07_0074.html)（isVecDeq=false）场景设置DEQSCALE寄存器的值。  
offset | 输入 | offset量化参数，int16_t类型，只有前9位有效。 用于[CastDeq](atlasascendc_api_07_0074.html)（isVecDeq=false）的场景，设置offset。  
signMode | 输入 | bool类型，表示量化结果是否带符号。 用于[CastDeq](atlasascendc_api_07_0074.html)（isVecDeq=false）的场景，设置signMode。  
vdeq | 输入 | 用于[CastDeq](atlasascendc_api_07_0074.html)（isVecDeq=true）的场景，输入量化tensor，大小为128Byte。 类型为[LocalTensor](atlasascendc_api_07_0006.html)，支持的TPosition为VECIN/VECCALC/VECOUT。 LocalTensor的起始地址需要32字节对齐。  
...
**父主题：** [量化设置](atlasascendc_api_07_0098.html)
