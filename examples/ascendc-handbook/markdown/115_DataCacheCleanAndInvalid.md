<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0177.html -->
...
![](/doc_center/source/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/figure/zh-cn_image_0000002520882426.png)
...
dcciDst | 表示使用该接口来保证Data Cache与哪一种存储保持一致性，类型为DcciDst枚举类。

  * CACHELINE_ALL：与CACHELINE_OUT效果一致。
  * CACHELINE_UB：表示通过该接口来保证Data Cache与UB的一致性。
  * CACHELINE_OUT：表示通过该接口来保证Data Cache与Global Memory的一致性。
  * CACHELINE_ATOMIC：
