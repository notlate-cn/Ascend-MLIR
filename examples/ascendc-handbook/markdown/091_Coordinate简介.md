<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_00143.html -->
...
Coordinate本质上是一个元组（tuple），用于表示张量在不同维度的位置信息，即坐标值。Coordinate（坐标）和[Layout](atlasascendc_api_07_00076.html)（布局）、Index（内存位置索引）之间存在紧密的关联：
...
参数名 | 描述  
---|---  
Coords | 表示输入数据类型的形参包，参数个数范围为[0，64]。 输入的数据类型支持size_t和Std::[Int](atlasascendc_api_07_10198.html)。  
...
**父主题：** [Coordinate](atlasascendc_api_07_00143.html)
