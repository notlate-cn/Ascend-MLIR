<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0047.html -->
...
![](/doc_center/source/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/figure/zh-cn_formulaimage_0000002552082277.png)
...
参数名 |  描述  
---|---  
T |  目的操作数数据类型。不同数据类型对应的精度转换规则见[表3](#ZH-CN_TOPIC_0000002552080023__table235404962912)。 Atlas A3 训练系列产品 / Atlas A3 推理系列产品 ，支持的数据类型为：int8_t、half。 Atlas A2 训练系列产品 / Atlas A2 推理系列产品 ，支持的数据类型为：int8_t、half。 Atlas 200I/500 A2 推理产品 ，支持的数据类型为int8_t、half。 Atlas 推理系列产品 AI Core，支持的数据类型为：int8_t、half。  
...
src0、src1 |  输入 |  源操作数。 类型为[LocalTensor](atlasascendc_api_07_0006.html)，支持的TPosition为VECIN/VECCALC/VECOUT。  
count |  输入 |  参与计算的元素个数。  
