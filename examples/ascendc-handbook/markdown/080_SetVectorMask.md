<!-- 原始URL: https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/900beta1/API/ascendcopapi/atlasascendc_api_07_0096.html -->
...
用于在矢量计算时设置mask，使用前需要先调用[SetMaskCount](atlasascendc_api_07_0094.html)/[SetMaskNorm](atlasascendc_api_07_0095.html)设置mask模式。在不同的模式下，mask的含义不同：
...
该接口仅在矢量计算API的isSetMask模板参数为false时生效，使用完成后需要使用[ResetMask](atlasascendc_api_07_0097.html)将mask恢复为默认值。

#### 调用示例

可结合[SetMaskCount](atlasascendc_api_07_0094.html)与[SetMaskNorm](atlasascendc_api_07_0095.html)使用，先设置mask的模式再设置mask：
