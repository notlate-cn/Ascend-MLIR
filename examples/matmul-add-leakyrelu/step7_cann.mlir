  ...
  func.func @matmul_add_leakyrelu(%arg0: memref<?x?xf16>, %arg1: memref<?x?xf16>, %arg2: memref<?xf32>, %arg3: memref<?x?xf32>, %arg4: memref<?x?xf32, strided<[1, 1], offset: ?>>, %arg5: memref<ui8>, %arg6: !emitasc.py_struct<"TilingData", [i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64], ["TB_M", "TB_N", "Tb_M", "Tb_N", "t_K", "dim_arg3_0", "dim_arg3_1", "dim_arg0_1", "dim_arg0_0", "dim_arg1_0", "dim_arg1_1", "dim_arg2_0", "dim_arg2_1"]>) attributes {ascendc.aicore, ascendc.global, ascendc.kernel_kind = "mix", cann.num_inputs = 4 : i32} {
    ...
    scf.if %48 {
      scf.for %arg7 = %c0 to %29 step %26 {
        ...
        %65 = ascendc.construct !ascendc.nd2nz_params(%62, %63, %62, %64, %62, %c0_i16, %62, %c0_i16) [ui16, ui16, ui16, ui16, ui16, ui16, ui16, ui16] : i16, i16, i16, i16, i16, i16, i16, i16
        ...
        %75 = ascendc.construct !ascendc.nd2nz_params(%64, %73, %64, %74, %64, %c0_i16, %64, %c0_i16) [ui16, ui16, ui16, ui16, ui16, ui16, ui16, ui16] : i16, i16, i16, i16, i16, i16, i16, i16
        ...
        scf.for %arg8 = %c0 to %50 step %25 {
          scf.for %arg9 = %c0 to %52 step %24 {
            ...
            %91 = ascendc.que_bind.alloc_tensor %18 : !ascendc.queue<co1, 1>, !ascendc.local_tensor<*xf32>
            scf.for %arg10 = %c0 to %53 step %23 {
              ...
              %126 = ascendc.construct !ascendc.load_data_2d_params(%c0_i16, %125, %122, %c0_i16, %c0_i16, %false, %c0_i8) [ui16, ui8, ui16, ui8, ui16, i1, ui8] : i16, i8, i16, i16, i16, i1, i8
              ...
              %130 = ascendc.construct !ascendc.load_data_2d_transpose_params(%c0_i16, %125, %c1_i16, %c0_i16, %c0_i16, %c0_i8) [ui16, ui8, ui16, ui16, ui16, ui8] : i16, i8, i16, i16, i16, i8
              ...
              %136 = ascendc.construct !ascendc.mmad_params(%133, %135, %134, %c0_i8, %c0_i8, %c0_i8) [ui16, ui16, ui16, ui8, ui8, ui8] : i16, i16, i16, i8, i8, i8
              ascendc.mmad %91, %131, %132, %136 {ascendc.unit = "AiCore.Cube"} : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, !ascendc.mmad_params
            ...
            ascendc.que_bind.enque_tensor %18, %91 : !ascendc.queue<co1, 1>, !ascendc.local_tensor<*xf32>
            ...
            ascendc.add_l2 %95, %96, %105, %89 {ascendc.unit = "AiCore.Vector"} : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
            ...
            ascendc.duplicate_l2 %108, %cst, %89 {ascendc.unit = "AiCore.Vector"} : !ascendc.local_tensor<*xf32>, f32, index
