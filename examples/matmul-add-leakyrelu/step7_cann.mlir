        ...
        scf.for %arg8 = %c0 to %50 step %25 {
          scf.for %arg9 = %c0 to %52 step %24 {
            ...
            scf.for %arg10 = %c0 to %53 step %23 {
              ...
              ascendc.mmad %91, %131, %132, %136 : !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, !ascendc.mmad_params
            ...
            ascendc.broadcast_l2 %105, %102, %103, %104, %c1_i32, %104 {constRank = 2 : i32, operandSegmentSizes = array<i32: 1, 1, 2, 2>} : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, i32, i32, i32, i32
            ascendc.add_l2 %95, %96, %105, %89 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
            ...
            ascendc.mul_l2 %106, %107, %108, %89 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
            ascendc.max_l2 %106, %107, %106, %89 : !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, !ascendc.local_tensor<*xf32>, index
