#define __AFIR_RUNTIME_MIX_KERNEL_FUN_H__
...
extern "C" __global__ __aicore__ void mm_relu__v0(
    GM_ADDR a, GM_ADDR b, GM_ADDR out, GM_ADDR workspace,
    GM_ADDR tilingGm) {
  ...
  if ASCEND_IS_AIV {
    ...
    const uint32_t vectorRegionOpCount = 2;
