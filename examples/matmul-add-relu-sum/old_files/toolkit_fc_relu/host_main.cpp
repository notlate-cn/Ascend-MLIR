...
#include <cstring>
#include "acl/acl.h"
#include "aclrtlaunch_auto_gen_fc_relu_kernel.h"
...
int main(){
  ...
  uint32_t rc = ACLRT_LAUNCH_KERNEL(auto_gen_fc_relu_kernel)(1, stream, aDev, bDev, biasDev, outDev, workspaceDev, tilingDev);
