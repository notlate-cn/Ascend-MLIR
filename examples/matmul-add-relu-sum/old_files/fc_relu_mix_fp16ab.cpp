// Trial variant of fc_relu_mix.cpp: keep the working KFC/REGIST_CUBE_OBJ skeleton,
// but change matmul inputs A/B from float32 to float16.
...
extern "C" __global__ __aicore__ void auto_gen_fc_relu_fp16ab_kernel(
