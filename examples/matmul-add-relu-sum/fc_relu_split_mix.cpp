#define __FC_RELU_SPLIT_MIX_KERNEL_FUN_H__
...
extern "C" __global__ __aicore__ void fc_relu_split_mix_origin(
...
extern "C" __global__ __aicore__ void auto_gen_fc_relu_split_kernel(
    GM_ADDR a, GM_ADDR b, GM_ADDR bias,
    GM_ADDR out, GM_ADDR workspace, GM_ADDR tilingGm)
{
...
#endif
#endif
    fc_relu_split_mix_origin(a, b, bias, out, workspace, tilingGm);
}

#if defined(__DAV_C220_CUBE__) || defined(__DAV_C310_CUBE__)
static const struct FunLevelMixCoreType fc_relu_split_mix_aic_section
...
static const struct FunLevelMixCoreType fc_relu_split_mix_aiv_section
