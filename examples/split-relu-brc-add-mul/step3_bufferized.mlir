  ...
  func.func @ewop_broadcast_split(%arg0: memref<?x?xf16>, %arg1: memref<?xf16>, %arg2: memref<?xf16>, %arg3: memref<?xf16>, %arg4: i64, %arg5: i64) -> (memref<?x?xf16>, memref<?x?xf16>) {
    ...
    %2 = scf.for %arg6 = %c0 to %dim step %1 iter_args(%arg7 = %alloc_2) -> (memref<?x?xf16>) {
      ...
      %5 = scf.for %arg8 = %c0 to %4 step %0 iter_args(%arg9 = %subview_6) -> (memref<?x?xf16, strided<[?, 1], offset: ?>>) {
        ...
        %subview_8 = memref.subview %subview_4[%arg8] [%6] [1] : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %subview_9 = memref.subview %subview_5[0] [%dim_0] [1] : memref<?xf16, strided<[1]>> to memref<?xf16, strided<[1]>>
        %subview_10 = memref.subview %arg9[%arg8, 0] [%6, %dim_0] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        linalg.generic {indexing_maps = [#map1, #map2, #map3, #map1], iterator_types = ["parallel", "parallel"]} ins(%subview_7, %subview_8, %subview_9 : memref<?x?xf16, strided<[?, 1], offset: ?>>, memref<?xf16, strided<[1], offset: ?>>, memref<?xf16, strided<[1]>>) outs(%subview_10 : memref<?x?xf16, strided<[?, 1], offset: ?>>) attrs =  {ascendc.unit = "AiCore.Vector"} {
        ^bb0(%in: f16, %in_11: f16, %in_12: f16, %out: f16):
          %7 = arith.maximumf %in, %cst : f16
          %8 = arith.addf %7, %in_11 : f16
          %9 = arith.mulf %8, %in_12 : f16
          linalg.yield %9 : f16
        }
