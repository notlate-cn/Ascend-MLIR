  ...
  func.func @ewop_broadcast_concat(%arg0: memref<?xf16>, %arg1: memref<?x?xf16>, %arg2: memref<?xf16>, %arg3: memref<?x?xf16>, %arg4: i64, %arg5: i64) -> memref<?x?xf16> {
    ...
    %3 = scf.for %arg6 = %c0 to %dim step %1 iter_args(%arg7 = %subview) -> (memref<?x?xf16, strided<[?, 1]>>) {
      ...
      %6 = scf.for %arg8 = %c0 to %5 step %0 iter_args(%arg9 = %subview_6) -> (memref<?x?xf16, strided<[?, 1], offset: ?>>) {
        ...
        %subview_9 = memref.subview %arg9[%arg8, 0] [%7, %dim_0] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        linalg.generic {indexing_maps = [#map1, #map2, #map2], iterator_types = ["parallel", "parallel"], library_call = "broadcast_add"} ins(%subview_7, %subview_8 : memref<?xf16, strided<[1], offset: ?>>, memref<?x?xf16, strided<[?, 1], offset: ?>>) outs(%subview_9 : memref<?x?xf16, strided<[?, 1], offset: ?>>) attrs =  {ascendc.unit = "AiCore.Vector"} {
        ^bb0(%in: f16, %in_10: f16, %out: f16):
          %8 = arith.addf %in, %in_10 : f16
          linalg.yield %8 : f16
        }
    ...
    %4 = scf.for %arg6 = %c0 to %dim_2 step %1 iter_args(%arg7 = %subview_1) -> (memref<?x?xf16, strided<[?, 1], offset: ?>>) {
      ...
      %6 = scf.for %arg8 = %c0 to %5 step %0 iter_args(%arg9 = %subview_6) -> (memref<?x?xf16, strided<[?, 1], offset: ?>>) {
        %7 = affine.min #map(%arg8)[%5, %0]
        %subview_7 = memref.subview %subview_4[%arg8] [%7] [1] : memref<?xf16, strided<[1], offset: ?>> to memref<?xf16, strided<[1], offset: ?>>
        %subview_8 = memref.subview %subview_5[%arg8, 0] [%7, %dim_3] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        %subview_9 = memref.subview %arg9[%arg8, 0] [%7, %dim_3] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        linalg.generic {indexing_maps = [#map1, #map2, #map2], iterator_types = ["parallel", "parallel"], library_call = "broadcast_mul"} ins(%subview_7, %subview_8 : memref<?xf16, strided<[1], offset: ?>>, memref<?x?xf16, strided<[?, 1], offset: ?>>) outs(%subview_9 : memref<?x?xf16, strided<[?, 1], offset: ?>>) attrs =  {ascendc.unit = "AiCore.Vector"} {
        ^bb0(%in: f16, %in_10: f16, %out: f16):
          %8 = arith.mulf %in, %in_10 : f16
          linalg.yield %8 : f16
        }
        memref.copy %subview_9, %subview_9 : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        scf.yield %arg9 : memref<?x?xf16, strided<[?, 1], offset: ?>>
