#!/usr/bin/env bash
# New Ascend mainline pipeline for elementwise + broadcast + concat.
...
echo "========================================================"
echo " elementwise + broadcast + concat Ascend mainline pipeline"
echo "========================================================"
echo "shape.M=$M"
echo "shape.N=$N"
...
log "  output: input_a.npy input_b.npy input_c.npy input_d.npy output.npy"
...
cat > "$RUN_MANIFEST" <<EOF
{
  ...
  "inputs": [
    ...
    { "name": "arg2", "path": "${BUILD_DIR}/input_c.npy" },
    { "name": "arg3", "path": "${BUILD_DIR}/input_d.npy" }
  ],
  "outputs": [
