...
module attributes {transform.with_named_sequence} {
  func.func @relu_transpose_broadcast_add(%arg0: memref<?x1xf16>, %arg1: memref<?x?xf16>, %arg2: i64, %arg3: i64) -> memref<?x?xf16> {
    ...
    scf.for %arg4 = %c0 to %dim_0 step %4 {
      %12 = affine.min #map(%arg4)[%dim_0, %4]
      %subview = memref.subview %arg0[0, 0] [%dim, 1] [1, 1] : memref<?x1xf16> to memref<?x1xf16, strided<[1, 1]>>
      %subview_1 = memref.subview %arg1[%arg4, 0] [%12, %dim] [1, 1] : memref<?x?xf16> to memref<?x?xf16, strided<[?, 1], offset: ?>>
      %subview_2 = memref.subview %alloc[%arg4, 0] [%12, %dim] [1, 1] : memref<?x?xf16> to memref<?x?xf16, strided<[?, 1], offset: ?>>
      scf.for %arg5 = %c0 to %12 step %3 {
        %13 = affine.min #map(%arg5)[%12, %3]
        %14 = arith.muli %dim, %c2 : index
        ...
        ascendc.global_tensor.set_global_buffer %16, %subview : !ascendc.global_tensor<*xf16>, memref<?x1xf16, strided<[1, 1]>>
        ascendc.data_copy_l2 %15, %16, %dim : !ascendc.local_tensor<*xf16>, !ascendc.global_tensor<*xf16>, index
        ...
        %subview_3 = memref.subview %subview_1[%arg5, 0] [%13, %dim] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        %subview_4 = memref.subview %subview_2[%arg5, 0] [%13, %dim] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        %18 = arith.muli %13, %dim : index
        %19 = arith.muli %18, %c2 : index
        ascendc.pipe.init_buffer %0, %10, %19 : !ascendc.tbuf<vecout>, index
        ascendc.pipe.init_queue %0, %2, %c1_i32, %19 : !ascendc.queue<vecout, 1>, i32, index
        ...
        ascendc.broadcast_l2 %23, %17, %21, %22, %c1_i32, %22 {ascendc.unit = "AiCore.Vector", constRank = 2 : i32, operandSegmentSizes = array<i32: 1, 1, 2, 2>} : !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, i32, i32, i32, i32
        %24 = ascendc.global_tensor : !ascendc.global_tensor<*xf16>
        ascendc.global_tensor.set_global_buffer %24, %subview_3 : !ascendc.global_tensor<*xf16>, memref<?x?xf16, strided<[?, 1], offset: ?>>
        ...
        ascendc.duplicate_l2 %27, %cst, %18 {ascendc.unit = "AiCore.Vector"} : !ascendc.local_tensor<*xf16>, f16, index
        ascendc.max_l2 %20, %23, %27, %18 {ascendc.unit = "AiCore.Vector"} : !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, index
        ascendc.add_l2 %20, %20, %26, %18 {ascendc.unit = "AiCore.Vector"} : !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, index
        ascendc.que_bind.enque_tensor %2, %20 : !ascendc.queue<vecout, 1>, !ascendc.local_tensor<*xf16>
        ...
        ascendc.data_copy_l2 %29, %28, %18 : !ascendc.global_tensor<*xf16>, !ascendc.local_tensor<*xf16>, index
