...
module {
  func.func @relu_index_select_add(%arg0: memref<?x?xf16>, %arg1: memref<?xi64>, %arg2: memref<?xf16>, %arg3: i64, %arg4: i64) -> memref<?x?xf16> {
    ...
    scf.if %12 {
      ...
      %subview_1 = memref.subview %alloc[%11, 0] [%13, %dim_0] [1, 1] : memref<?x?xf16> to memref<?x?xf16, strided<[?, 1], offset: ?>>
      scf.for %arg5 = %c0 to %13 step %3 {
        ...
        %subview_2 = memref.subview %subview_1[%arg5, 0] [%14, %dim_0] [1, 1] : memref<?x?xf16, strided<[?, 1], offset: ?>> to memref<?x?xf16, strided<[?, 1], offset: ?>>
        ...
        scf.for %arg6 = %c0 to %14 step %c1 {
          ...
          ascendc.data_copy_l2 %33, %32, %dim_3 : !ascendc.local_tensor<*xf16>, !ascendc.global_tensor<*xf16>, index
          ...
          ascendc.duplicate_l2 %36, %cst, %21 : !ascendc.local_tensor<*xf16>, f16, i32
          ascendc.max_l2 %35, %35, %36, %21 : !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, i32
          %37 = ascendc.tbuf.get_tensor %5 : !ascendc.tbuf<gm>, !ascendc.local_tensor<*xf16>
          ascendc.add_l2 %35, %35, %37, %21 : !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, !ascendc.local_tensor<*xf16>, i32
        }
        ...
        ascendc.global_tensor.set_global_buffer %28, %subview_2 : !ascendc.global_tensor<*xf16>, memref<?x?xf16, strided<[?, 1], offset: ?>>
