...
static std::string emitCMakeLists(const std::string& repo_root,
  ...
  return "cmake_minimum_required(VERSION 3.16)\n"
         ...
         "set(DAV_SIM_LIB_DIR \"\")\n"
         "set(DEVICE_LIB_DIR \"\")\n"
         "set(_ASCEND_DEVICE_SHORT_ARCH \"\")\n"
         "if(NOT ASCEND_HOST_ARCH STREQUAL \"\")\n"
         "  set(SOC_SIM_LIB_DIR \"${ASCEND_CANN_PACKAGE_PATH}/${ASCEND_HOST_ARCH}/simulator/${SOC_VERSION}/lib\")\n"
         "  set(DEVICE_LIB_DIR \"${ASCEND_CANN_PACKAGE_PATH}/${ASCEND_HOST_ARCH}/lib64/device/lib64\")\n"
         "endif()\n"
         "if(CMAKE_SYSTEM_PROCESSOR MATCHES \"^(x86_64|amd64)$\")\n"
         "  set(_ASCEND_DEVICE_SHORT_ARCH \"x86_64\")\n"
         "elseif(CMAKE_SYSTEM_PROCESSOR MATCHES \"^(aarch64|arm64)$\")\n"
         "  set(_ASCEND_DEVICE_SHORT_ARCH \"aarch64\")\n"
         "endif()\n"
         "if(_ASCEND_DEVICE_SHORT_ARCH STREQUAL \"x86_64\" AND EXISTS \"${ASCEND_CANN_PACKAGE_PATH}/devlib/linux/${_ASCEND_DEVICE_SHORT_ARCH}/libascend_hal.so\")\n"
         "  set(DEVICE_LIB_DIR \"${ASCEND_CANN_PACKAGE_PATH}/devlib/linux/${_ASCEND_DEVICE_SHORT_ARCH}\")\n"
         "elseif(NOT EXISTS \"${DEVICE_LIB_DIR}/libascend_hal.so\" AND NOT _ASCEND_DEVICE_SHORT_ARCH STREQUAL \"\")\n"
         "  set(DEVICE_LIB_DIR \"${ASCEND_CANN_PACKAGE_PATH}/devlib/linux/${_ASCEND_DEVICE_SHORT_ARCH}\")\n"
         "endif()\n"
         ...
         ")\n\n"
         "if(EXISTS \"${DEVICE_LIB_DIR}\")\n"
         "  target_link_options(mix_runner PRIVATE -Wl,-rpath-link,${DEVICE_LIB_DIR})\n"
         "endif()\n\n"
