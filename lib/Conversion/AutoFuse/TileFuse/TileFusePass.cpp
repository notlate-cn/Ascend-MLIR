...
#define GEN_PASS_DECL_AUTOFUSETILEFUSE
#define GEN_PASS_DEF_AUTOFUSETILEFUSE
...
struct AutoFuseTileFusePass
    : public ::impl::AutoFuseTileFuseBase<AutoFuseTileFusePass> {
...
std::unique_ptr<Pass> createAutoFuseTileFusePass() {
  return std::make_unique<AutoFuseTileFusePass>();
}
