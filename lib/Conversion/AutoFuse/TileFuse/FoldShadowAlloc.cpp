...
#define GEN_PASS_DECL_AUTOFUSEFOLDSHADOWALLOC
#define GEN_PASS_DEF_AUTOFUSEFOLDSHADOWALLOC
#include "Conversion/Passes.h.inc"

#define DEBUG_TYPE "auto-fuse-fold-shadow-alloc"
...
struct AutoFuseFoldShadowAllocPass
    : public ::impl::AutoFuseFoldShadowAllocBase<
          AutoFuseFoldShadowAllocPass> {
...
std::unique_ptr<Pass> createAutoFuseFoldShadowAllocPass() {
  return std::make_unique<AutoFuseFoldShadowAllocPass>();
}
