...
#define GEN_PASS_DECL_AUTOFUSEBROADCASTABSORB
#define GEN_PASS_DEF_AUTOFUSEBROADCASTABSORB
...
struct AutoFuseBroadcastAbsorbPass
    : public ::impl::AutoFuseBroadcastAbsorbBase<
          AutoFuseBroadcastAbsorbPass> {
...
std::unique_ptr<Pass> createAutoFuseBroadcastAbsorbPass() {
  return std::make_unique<AutoFuseBroadcastAbsorbPass>();
}
