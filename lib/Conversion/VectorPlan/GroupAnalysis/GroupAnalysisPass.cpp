...
#define GEN_PASS_DECL_VECTORPLANGROUPANALYSIS
#define GEN_PASS_DEF_VECTORPLANGROUPANALYSIS
...
struct VectorPlanGroupAnalysisPass
    : public ::impl::VectorPlanGroupAnalysisBase<VectorPlanGroupAnalysisPass> {
  ...
  void runOnOperation() override {
    ...
    auto groupIdName   = StringAttr::get(ctx, "vector_plan.group_id");
    auto topoIndexName = StringAttr::get(ctx, "vector_plan.topo_index");
