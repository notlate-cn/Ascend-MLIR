...
using ::mlir::ascend::kScheduleFamilyCubeStaticMatmul;
using ::mlir::ascend::kScheduleFamilyMemoryCopy;
using ::mlir::ascend::kScheduleFamilyReductionStatic;
using ::mlir::ascend::kScheduleFamilyVectorGeneric;
...
using ::mlir::ascend::kScheduleTemplateGroupedTilePerBlock;
using ::mlir::ascend::kScheduleTemplateSingleTilePerBlock;
