//===- KernelizeSemanticUtils.cpp - Kernelize semantic helpers --------===//
//
...
bool matchLinalgSemanticOp(Operation *op) { return isa<linalg::LinalgOp>(op); }
...
LogicalResult populateArithConstantSemanticInfo(
    Operation *, KernelizeOpSemanticInfo &info, llvm::StringRef modelName) {
